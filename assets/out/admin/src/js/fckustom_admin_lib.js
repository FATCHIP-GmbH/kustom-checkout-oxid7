...
var MultiLangWidget = {
     ...
     * @path string  'cl=kustom_general', 'cl=kustom_general&fcn=someMethod'
     */
    ...
    /**
     * {langSelectorId: 'langSelector', formCssSelector: 'form#myedit', toggleCssSelector: '#anonymized', inputsCssSelector: '#anonymized-value', dataPath: 'cl=kustom_general'}
     * @param settings
     */
