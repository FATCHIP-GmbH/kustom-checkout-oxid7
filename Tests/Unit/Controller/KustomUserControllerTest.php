...
/**
 * Class KustomUserControllerTest
 * @package Fatchip\FcKustom\Tests\Unit\Controller
 * @covers \Fatchip\FcKustom\Controller\KustomUserController
 */
class KustomUserControllerTest extends ModuleUnitTestCase
{

    public function initDataProvider()
    {
        $url = $this->removeQueryString($this->getConfig()->getShopSecureHomeUrl()) . 'cl=KustomExpress';
    ...
    public function testKustomResetCountry()
    {
        $sUrl = $this->getConfig()->getShopSecureHomeURL() . 'cl=KustomExpress&reset_kustom_country=1';
        $invadr = [
        ...
        $oUserController->kustomResetCountry();
