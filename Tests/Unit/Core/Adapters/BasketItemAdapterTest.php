...
use Fatchip\FcKustom\Core\Adapters\BaseBasketItemAdapter;
use Fatchip\FcKustom\Core\Adapters\BasketItemAdapter;
...
class BasketItemAdapterTest extends ModuleUnitTestCase
{
    ...
    public function validateItemDP()
    {
        $validOrderLine = $invalidOrderLineQuantity = $invalidOrderLineTotalAmount = [
          ...
          "merchant_data" => "{\"type\":\"basket_item\"}",
          "product_url" => "http://demohost.topconcepts.net/arek/kustom/ce_620/source/en/Special-Offers/Transport-container-BARREL.html",
          "image_url" => "http://demohost.topconcepts.net/arek/kustom/ce_620/source/out/pictures/generated/product/1/540_340_75/mikejucker_textilcontainer_1.jpg",
          "product_identifiers" => [
