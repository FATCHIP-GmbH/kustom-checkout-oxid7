...
class KustomOrderValidatorTest extends ModuleUnitTestCase
{
    ...
    public function orderDataProvider()
    {
        ...
        return [
            ...
            [ $orderdata, $outOfStockArticle, ['FCKUSTOM_ERROR_NOT_ENOUGH_IN_STOCK' => 'artNum'], false ],
    ...
    {
        $orderData = ['orderData'];
        $oOrderValidator = new KustomOrderValidator($orderData);
    ...
    public function testValidateOrder($orderData, $articleErrors, $resultErrors, $eRes)
    {
        ...
        $oArticle = $this->getMockBuilder(Article::class)
            ->setMethods(['kustom_loadByArtNum', 'checkForStock', 'isLoaded', 'isBuyable'])
            ->getMock();
