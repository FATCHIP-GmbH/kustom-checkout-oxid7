...
abstract class BaseCallbackController extends BaseController
{
    ...
    public function init() {
        ...
        KustomUtils::log('info', $this->getFncName() . " request:\n" , $this->requestData);
        if ($this->validateRequestData() === false) {
            Registry::getUtils()->showMessageAndExit('');
        }
        $loggingEnabeld = Registry::getConfig()->getConfigParam('blKustomLoggingEnabled');
    ...
    {
        KustomUtils::log('debug', 'CALLBACK_RESPONSE: ' .
            print_r($data, true)
        );
